...
class Agent(object):  # pylint: disable=too-few-public-methods
    ...
    require to implement the Agent's functionality. Each of these methods should
    ...
    def _taskMethod(self, input_file, output_file):  # pylint: disable=no-self-use,invalid-name,unused-argument
        """
        This method performs the actions required to achieve the Agent's
    ...
    def run(self, input_files, input_metadata, output_files):  # pylint: disable=unused-argument
        ...
        Agent. This usually involves:
        0. Import agent-specific libraries
        1. Perform relevant checks on input data
        2. Optionally convert input data to internal formats
        3. Perform agent-specific operations
        ...
        In case of failure, the Agent should return None instead of the output
